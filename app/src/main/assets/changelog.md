...
## [3.3.0] — 2017-09-28
### Added
- You can now customize which apps are excluded from filtering. Exclude an app from the Blue Light Filter notification while that app is running.
...
- When turning off, don't change the backlight brightness if was changed since Blue Light Filter lowered it.
- Fix crash when upgrading between 3.1.x versions.
- Fix a bug where profiles would not be saved until Blue Light Filter was closed and re-opened.
...
## [3.1.0] — 2017-09-02
### Added
- Long press on the quick settings tile to open Blue Light Filter
...
- Fixed bugs when Blue Light Filter is killed throug Android
...
- Fixed a bug where changes to 'Pause in secure apps' did not apply until Blue Light Filter was killed
...
- Notification shows when Blue Light Filter is paused in a secure app
...
- [For developers and power users] Notify other apps when Blue Light Filter toggles (details on the about page).
- Added Italian translation — @matteocoder

### Changed
- Refer to "Blue Light Filter" instead of "The filter"
- Top switch toggles Blue Light Filter on and off (instead of enabling/disabling all functionality)
- Update notification and widget phrasing/icons
- Updated translations

### Fixed
- Don't stop searching for location when the app is closed
- Fixed a bug where Blue Light Filter didn't pause in new versions of the package installer
- Many small bugfixes
